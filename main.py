...
# --- Função de PDF Ajustada (Sem N/A) ---
def gerar_pdf_etiqueta(nome, codigo, categoria, qtd):
    ...
    try:
        c.drawImage("download.png", 5*mm, 28*mm, width=20*mm, height=18*mm, preserveAspectRatio=True)
    except: pass
    
    # Se categoria for "N/A", não imprime nada no lugar
...
with aba2:
    # Mantém o carregamento persistente
    df = carregar_dados()
